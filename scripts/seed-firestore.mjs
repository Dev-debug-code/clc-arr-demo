...
const BASELINE_REQUIREMENTS = [
  ...
  { id: "cc-2", codeArea: "client-care", label: "Scope communicated clearly", status: "non_compliant" },
  { id: "cc-3", codeArea: "client-care", label: "Fees transparency evidence", status: "not_assessed" },
  { id: "ac-1", codeArea: "accounts", label: "Client account reconciliations", status: "compliant" },
  { id: "ac-2", codeArea: "accounts", label: "Residual balances controls", status: "non_compliant" },
  { id: "mg-1", codeArea: "management", label: "Supervision process documented", status: "not_applicable" },
