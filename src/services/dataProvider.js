...
export const deleteCaseRecord = (...args) => provider.deleteCaseRecord(...args);
...
export const persistUploadItemDelete = (...args) => provider.persistUploadItemDelete(...args);
export const persistConfirmAllUploads = (...args) => provider.persistConfirmAllUploads(...args);
export const persistGeneratedWorkspace = (...args) => provider.persistGeneratedWorkspace(...args);
...
export const runSimulatedClassification = (...args) => provider.runSimulatedClassification(...args);
export const runSimulatedFindingsGeneration = (...args) => provider.runSimulatedFindingsGeneration(...args);
